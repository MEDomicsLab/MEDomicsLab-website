...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(
    (el) => {
      ...
      const hasExplicitSize = openedImageWidth || openedImageHeight;
      const useNaturalSize = !hasExplicitSize;
      const applyNaturalSize = () => {
        ...
        const maxWidth = frameR.width;
        const maxHeight = frameR.height;
      ...
      const wantsResize = hasExplicitSize || useNaturalSize;
      if (wantsResize) {
        const onFirstEnd = (ev) => {
          ...
          if (hasExplicitSize) {
            ...
            overlay.style.transition = `left ${enlargeTransitionMs}ms ease, top ${enlargeTransitionMs}ms ease, width ${enlargeTransitionMs}ms ease, height ${enlargeTransitionMs}ms ease`;
            if (img.complete) {
              requestAnimationFrame(applyNaturalSize);
            } else {
              img.onload = () => requestAnimationFrame(applyNaturalSize);
            }
          }
          const cleanupSecond = () => {
